export const translations = {
  vi: {
    ...
    home: {
      ...
      heroSubtitle: "Thực phẩm eat clean chất lượng cao, dinh dưỡng cân đối cho lối sống lành mạnh",
      ctaButton: "Khám phá sản phẩm",
      feature1Title: "100% Tự nhiên",
      feature1Desc: "Nguyên liệu organic, không chất bảo quản",
      feature2Title: "Giàu dinh dưỡng",
    ...
    productDetail: {
      ...
      allergenWarning: "Sản phẩm này có chứa:",
      orderButton: "Đặt món ngay",
      deliveryInfo: "🚚 Giao hàng trong vòng 60 phút tại TP.HCM"
    },
    ...
    about: {
      ...
      value1Desc: "100% nguyên liệu organic, không hóa chất",
      value2Title: "Tận tâm",
      value2Desc: "Chăm sóc sức khỏe khách hàng như chính gia đình",
      value3Title: "Tươi mới",
      value3Desc: "Chế biến và giao hàng trong ngày",
      value4Title: "Chất lượng",
      value4Desc: "Kiểm soát nghiêm ngặt từng khâu sản xuất",
      contactTitle: "Liên hệ với chúng tôi",
      addressLabel: "Địa chỉ",
      addressText: "123 Đường Visionaries, TP.HCM",
    ...
    orderForm: {
      ...
      addressPlaceholder: "123 Đường ABC, TP.HCM",
  ...
  en: {
    ...
    home: {
      ...
      feature1Desc: "Organic ingredients, no preservatives",
      feature2Title: "Rich in Nutrition",
    ...
    productDetail: {
      ...
      allergenWarning: "This product contains:",
      orderButton: "Order Now",
      deliveryInfo: "🚚 Delivery within 60 minutes in Ho Chi Minh City"
    },
    ...
    about: {
      ...
      value1Title: "Natural",
      value1Desc: "100% organic ingredients, no chemicals",
      value2Title: "Dedicated",
      value2Desc: "Care for customers' health like family",
      value3Title: "Fresh",
      value3Desc: "Prepared and delivered same day",
      value4Title: "Quality",
